...
public class EmailFaleConosco implements Serializable{
	...
	public void sendEmail() {
		...
		mj.setUserMail("alugesustentvel@gmail.com");
		mj.setFromNameMail("AlugeSustentvel - Fale Conosco");
		mj.setPassMail("alugesustentvel123");
		...
		map.put("alugesustentvel@gmail.com", "email gmail");
